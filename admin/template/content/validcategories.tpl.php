...
<html>
<head>
<title><?php echo sysLanguage::get('HEADING_TITLE');?></title>
<style type="text/css">
<!--
...
<tr>
<td colspan="4">
<h4><?php echo sysLanguage::get('TEXT_VALID_CATEGORIES_LIST'); ?></h4>
</td>
</tr>
<?
    echo "<tr><th>" . sysLanguage::get('TEXT_VALID_CATEGORIES_ID') . "</th><th>" . TEXT_VALID_CATEGORIES_NAME . "</th></tr><tr>";
