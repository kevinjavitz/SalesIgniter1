...
var sConnUrl = '<?php echo sysConfig::getDirWsAdmin();?>rentalwysiwyg/editor/filemanager/connectors/php/connector.php';
...
{
	var sUrl = '<?php echo sysConfig::getDirWsAdmin().'rentalwysiwyg/editor/filemanager/connectors/php/connector.php?Command=';?>' + command;
	sUrl += '&Type=' + this.ResourceType ;
	if(typeof window.opener.currentFolder == 'undefined'){
		window.opener.currentFolder = this.CurrentFolder +'/images';
		sUrl += '&CurrentFolder=' + encodeURIComponent( this.CurrentFolder +'/images') ;
	}else{
		sUrl += '&CurrentFolder=' + encodeURIComponent( window.opener.currentFolder) ;
	}
