...
define('TABLE_WISHLIST', 'customers_wishlist');
  define('TABLE_WISHLIST_ATTRIBUTES', 'customers_wishlist_attributes');
	...
	define('TABLE_RENTAL_QUEUE_CONFIRM', 'rental_queue_confirm');
	define('TABLE_RENTAL_PRODUCTS_CONFIRM', 'rental_products_confirm');
	...
	define('TABLE_PRODUCTS_INVENTORY_QUANTITY_COMMENTS', 'products_inventory_quantity_comments');
	
	define('TABLE_ORDERS_ADDRESSES', 'orders_addresses');
	define('TABLE_ORDERS_PAYMENTS_HISTORY', 'orders_payments_history');
	define('TABLE_PRODUCTS_PACKAGES', 'products_packages');
	
define('TABLE_CUSTOMERS_MEMBERSHIP', 'customers_membership');
