 ...
 */
      ...
      $this->build_params['html_charset'] = sysLanguage::getCharset();
      $this->build_params['text_charset'] = sysLanguage::getCharset();
...
// If duplicate images are embedded, they may show up as attachments, so remove them.
	  ...
	  function add_text($text = '') {
		  $this->text = $this->convert_html_to_text($text);//tep_convert_linefeeds(array("\r\n", "\n", "\r"), $this->lf, $text);
	  }
 ...
 */
    ...
    function add_html($html, $text = NULL, $images_dir = NULL) {
      ...
      $this->html_text = $html;//tep_convert_linefeeds(array("\r\n", "\n", "\r"), $this->lf, $text);
