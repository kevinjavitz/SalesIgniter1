...
?>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo sysConfig::getDirWsCatalog();?>extensions/templateManager/catalog/globalFiles/stylesheet.php?layout_id=<?php echo $templateLayoutId;?>&tplDir=<?php echo Session::get('tplDir');?>&import=<?php echo implode(',', $stylesheets);?>" />
		...
		<script type="text/javascript" src="<?php echo sysConfig::getDirWsCatalog();?>extensions/templateManager/catalog/globalFiles/javascript.php?layout_id=<?php echo $templateLayoutId;?>&tplDir=<?php echo Session::get('tplDir');?>&import=<?php echo implode(',', $javascriptFiles);?>"></script>
	</head>
	<body>
		<noscript>
			<div class="noscript">
