...
if (isset($WidgetSettings->showParentCat) && $WidgetSettings->showParentCat == 'showParentCat'){
	$checkedshowParentCat = 'checked="checked"';
}
...
<fieldset>
	...
	<table cellpadding="0" cellspacing="0" border="0" class="scrollerConfig">
		...
		<tr>
			<td>Show Parent Category in Title:</td>
			<td><input type="checkbox" name="showParentCat" value="showParentCat" <?php echo $checkedshowParentCat;?>></td>
		</tr>
		<tr>
