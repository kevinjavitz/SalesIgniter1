(function($, undefined) {
	...
	$.fn.backgroundBuilder.presto.image = function (o) {
		...
		if (!inputVals.presto.background.image){
			inputVals.presto.background.image = {
				config  : {},
				images  : []
			};
		}
		...
		this.showSettings = function () {
			var self = this;
			var inputVals = this.activeEl.data('styles_info').input_vals.presto.background.image;
