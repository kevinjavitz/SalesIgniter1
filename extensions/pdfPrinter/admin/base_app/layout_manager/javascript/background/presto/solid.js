(function($, undefined) {
	...
	$.fn.backgroundBuilder.presto.solid = function (o) {
		...
		if (!inputVals.presto.background.solid){
			inputVals.presto.background.solid = {
				config : {},
				color  : ''
			};
		}
		...
		this.showSettings = function () {
			var self = this;
			var inputVals = this.activeEl.data('styles_info').input_vals.presto.background.solid;
