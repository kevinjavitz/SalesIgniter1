<?php
	...
	if ($myReviews){
		foreach($myReviews as $reviews){
			...
			$productImage = '<img src="imagick_thumb.php?width=150&height=150&path=rel&imgSrc='. sysConfig::getDirWsCatalog(). sysConfig::get('DIR_WS_IMAGES'). $reviews['Products'][0]['products_image'].'" alt="'.$productName.'"/>';
