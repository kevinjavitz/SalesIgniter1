...
class metaTags_catalog_products_best_sellers extends Extension_metaTags {
	...
	private function fetchMetatags () {
		...
		$metaTagsBestSeller	= $this->fetchPageMetaTags('B', $lID);

		if ($metaTagsBestSeller) {
			$this->title	= $metaTagsBestSeller[$lID]['t'];
			$this->desc		= $metaTagsBestSeller[$lID]['d'];
			$this->keyword	= $metaTagsBestSeller[$lID]['k'];
		}
