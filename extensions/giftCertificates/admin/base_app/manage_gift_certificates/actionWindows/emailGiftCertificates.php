<?php
    ...
    $infoBox->addContentRow('<table cellpadding="3" cellspacing="0" border="0">' .
                            '<tr>' .
                            '<td>' . sysLanguage::get('TEXT_INFO_GIFT_CERTIFICATES') . '</td>' .
                            '<td>' . $GiftCertificate->GiftCertificatesDescription[0]->gift_certificates_name . '</td>' .
                            '</tr>' .
                            '<tr>' .
