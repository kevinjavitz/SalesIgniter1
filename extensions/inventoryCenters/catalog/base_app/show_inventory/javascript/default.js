 ...
 function recenterMap(){
	...
	// alert($('input[name="inventory_center_address"]').val());
	 if($('input[name="inventory_center_address"]').val())
         geocoder.getLocations($('input[name="inventory_center_address"]').val(), geocodeResult);
	 else
	    showAddress($('input[name="inventory_center_address"]').val());
 }
