...
if($_GET['city'] && $_GET['city'] != ''){
    $invcent->andWhere('inventory_center_city=?', $_GET['city']);
}

if($_GET['continent'] && $_GET['continent'] != ''){
    $invcent->andWhere('inventory_center_continent=?', $_GET['continent']);
}

if($_GET['state'] && $_GET['state']  != ''){
    $invcent->andWhere('inventory_center_state=?', $_GET['state']);
}

if($_GET['country']  && $_GET['country']  != ''){
    $invcent->andWhere('inventory_center_country=?', $_GET['country'] );
}
