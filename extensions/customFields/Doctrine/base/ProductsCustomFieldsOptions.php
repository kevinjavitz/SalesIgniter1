...
class ProductsCustomFieldsOptions extends Doctrine_Record {
	
	public function setUp(){
		$this->hasMany('ProductsCustomFieldsOptionsDescription', array(
			'local'   => 'option_id',
			'foreign' => 'option_id',
	...
	public function setTableDefinition(){
		$this->setTableName('products_custom_fields_options');
