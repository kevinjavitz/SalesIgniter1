$(document).ready(function (){
	...
	$('#moveRight').click(function (){
		if ($('option:selected', $('#productList')).size() > 0){
			...
			var newHTML = $('<div><a href="Javascript:void()" class="ui-icon ui-icon-circle-close removeButton"></a><span class="main">' + productName + '</span><input type="hidden" name="product_groups[]" value="' + productID + '"></div>');
