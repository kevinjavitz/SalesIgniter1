<?php
	...
	EventManager::attachActionResponse('This will remove you current group and replace it with the selected one.<br /><br />' . $selectBox->draw() . '<br /><br /><small>*Changes are not saved until the product is saved</small>', 'html');
?>