<?php
	...
	$tableGrid->addButtons(array(
		htmlBase::newElement('button')->setText('Install Modules')->setHref(itw_app_link('appExt=downloadProducts', 'providers', 'modules')),
		htmlBase::newElement('button')->setText('New')->addClass('newButton'),
		htmlBase::newElement('button')->setText('View Files')->addClass('viewButton')->disable(),
