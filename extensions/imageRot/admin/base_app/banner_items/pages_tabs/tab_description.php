  ...
  <tr>
   ...
   <td class="main"><?php echo $BannerBody->draw()."<br/>";
	   if (isset($Banner) && substr($Banner['banners_body'],strlen($Banner['banners_body'])-3,3)!='swf' && !empty($Banner['banners_body'])){
            echo "<img src='".sysConfig::getDirWsCatalog().'extensions/imageRot/images/'. $Banner['banners_body']."' />";
	   }else{
		   echo getFlashMovie(sysConfig::getDirWsCatalog().'extensions/imageRot/images/'. $Banner['banners_body'],"Flash not installed",'150','400');
	   }
...
<tr>
   ...
   <td class="main"><?php echo $BannerBodyThumbs->draw()."<br/>";
	   if (isset($Banner) && !empty($Banner['banners_body_thumbs'])){
            echo "<img src='".sysConfig::getDirWsCatalog().'extensions/imageRot/images/'. $Banner['banners_body_thumbs']."' />";
       }
?>
