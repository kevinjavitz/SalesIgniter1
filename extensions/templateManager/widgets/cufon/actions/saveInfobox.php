...
if (isset($_POST['fontSortable'])){
	$fontsSortable = array();
	parse_str($_POST['fontSortable'], &$fontsSortable);

	$fonts = array();
	foreach($fontsSortable['font'] as $displayOrder => $fontNumber){
		$fonts[] = array(
			'font' => $_POST['fontSelect'][$fontNumber],
			'fontFamily' => $_POST['fontFamily'][$fontNumber],
			'fontElements' => $_POST['fontElements'][$fontNumber],
			'fontSize' => $_POST['fontSize'][$fontNumber],
			'fontColor' => $_POST['fontColor'][$fontNumber],
			'fontShadow' => $_POST['fontShadow'][$fontNumber],
			'fontFamilyHover' => $_POST['fontFamilyHover'][$fontNumber],
			'fontSizeHover' => $_POST['fontSizeHover'][$fontNumber],
			'fontColorHover' => $_POST['fontColorHover'][$fontNumber],
			'fontShadowHover' => $_POST['fontShadowHover'][$fontNumber]
		);
	}
	$WidgetProperties['fonts'] = $fonts;
}
/*
