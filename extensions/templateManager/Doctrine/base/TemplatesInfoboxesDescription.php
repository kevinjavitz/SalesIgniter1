 ...
 */
class TemplatesInfoboxesDescription extends Doctrine_Record {
	...
	public function setTableDefinition(){
		$this->setTableName('templates_infoboxes_description');
	...
	public function newLanguageProcess($fromLangId, $toLangId){
		...
		foreach($Qdescription as $Record){
			...
			EventManager::notify('TemplatesInfoboxesDescriptionNewLanguageProcessBeforeTranslate', $toTranslate);
			
			$translated = sysLanguage::translateText($toTranslate, (int) $toLangId, (int) $fromLangId);
			
			$newDesc = new TemplatesInfoboxesDescription();
			...
			EventManager::notify('TemplatesInfoboxesNewLanguageProcessBeforeSave', $newDesc);
	...
	public function cleanLanguageProcess($existsId){
		...
		->delete('TemplatesInfoboxesDescription')
