(function($, undefined) {
	...
	$.fn.backgroundBuilder.webkit.gradient = function (o){
		...
		if (!inputVals.webkit.background.gradient){
			inputVals.webkit.background.gradient = {
				config       : {},
				colorStops   : [],
				imagesBefore : [],
				imagesAfter  : []
		...
		this.showSettings = function (){
			var self = this;
			var inputVals = this.activeEl.data('styles_info').input_vals.webkit.background.gradient;
		...
		this.updateGradient = function (){
			...
			inputVals.webkit.background.gradient.config = {
			...
			inputVals.webkit.background.gradient.colorStops = [];
			$sCont.find('.gradientStop').each(function (){
				inputVals.webkit.background.gradient.colorStops.push({
			...
			inputVals.webkit.background.gradient.imagesBefore = [];
			$sCont.find('.gradientImagesBefore .gradientImage').each(function (){
				inputVals.webkit.background.gradient.imagesBefore.push({
			...
			inputVals.webkit.background.gradient.imagesAfter = [];
			$sCont.find('.gradientImagesAfter .gradientImage').each(function (){
				inputVals.webkit.background.gradient.imagesAfter.push({
					image_background_color_r : $(this).find('input[name=image_background_color_r]').val(),
					image_background_color_g : $(this).find('input[name=image_background_color_g]').val(),
					image_background_color_b : $(this).find('input[name=image_background_color_b]').val(),
					image_background_color_a : $(this).find('input[name=image_background_color_a]').val(),
			...
			var StylesInfo = this.activeEl.data('styles_info');
			StylesInfo.input_vals.webkit.background.gradient = inputVals.webkit.background.gradient;
		...
		this.createImage = function (loc, values){
			...
			$newImage.find('input[name=image_background_color_r], input[name=image_background_color_g], input[name=image_background_color_b], input[name=image_background_color_a]').each(function (){
				$(this).keyup(function (){
