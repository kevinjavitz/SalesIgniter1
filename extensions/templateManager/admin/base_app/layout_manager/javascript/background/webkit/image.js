(function($, undefined) {
	...
	$.fn.backgroundBuilder.webkit.image = function (o){
		...
		if (!inputVals.webkit.background.image){
			inputVals.webkit.background.image = {
				config  : {},
				images  : []
			};
		}
		...
		this.showSettings = function (){
			var self = this;
			var inputVals = this.activeEl.data('styles_info').input_vals.webkit.background.image;
