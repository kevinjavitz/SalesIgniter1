	...
	class StreamProviderInstaller {
		...
		public function __construct($moduleCode, $extName = null){
			...
			if (is_null($extName) === false){
				...
				$this->moduleDir .= 'extensions/streamProducts/providerModules/' . $moduleCode . '/';
			}
			...
			$className = 'StreamProvider' . ucfirst($moduleCode);
		...
		public function install(){
			if ($this->moduleCls->isInstalled() === false){
				...
				$moduleConfig->modules_type = 'stream_provider';
