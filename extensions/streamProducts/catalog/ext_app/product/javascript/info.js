...
$(document).ready(function () {
    ...
    $.ajax({
        cache:false,
        dataType:'json',
        url:js_app_link('appExt=streamProducts&app=main&appPage=default&action=getPlayerConfig&pID=' + document.getElementById('pID').value + '&sID=' + document.getElementById('sID').value),
