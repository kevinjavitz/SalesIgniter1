...
(function () {
	...
	function u(a) {return da(a) == "array"}
	...
	function w(a) {return typeof a == "string"}

	function x(a) {return da(a) == "function"}
	...
	function y(a) {return a[fa] || (a[fa] = ++ga)}
	...
	function ta() {return Array.prototype.join.call(arguments, "")}
	...
	function ya(a) {i(new wa("Failure" + (a ? ": " + a : ""), Array.prototype.slice.call(arguments, 1)))}
	...
	function Ga(a, b, c, d) {
		if (a.reduce){
			return d ? a.reduce(ha(b, d), c) : a.reduce(b, c);
		}
		var e = c;
		Fa(a, function (f, g) {e = b.call(d, e, f, g, a)});
		return e
	}
	...
	function Ia() {return A.concat.apply(A, arguments)}
	...
	function Ka(a) {
		for(var b = 1; b < arguments.length; b++){
			var c = arguments[b], d;
			if (u(c) || (d = v(c)) && c.hasOwnProperty("callee")){
				a.push.apply(a, c);
			}
			else {
				if (d){
	...
	Qa.prototype.next = function () {i(Pa)};
	Qa.prototype.ra = function () {return this};
	function Ra(a) {
		if (a instanceof Qa){
			return a;
		}
	...
	function Ta(a) {
		...
		if (b > 1){
			if (b % 2){
				i(Error("Uneven number of arguments"));
			}
			for(var c = 0; c < b; c += 2){
				this.w(arguments[c], arguments[c + 1])
			}
		}
		else {
			if (a){
	...
	p.C = function (a) {return Va(this.p, a)};
	p.clear = function () {
		this.p = {};
	...
	p.A = function () {return new Ta(this)};
	p.ra = function (a) {
		Ua(this);
		...
		g.next = function () {
			for(; ;){
				if (e != f.ha){
					i(Error("The map has changed since the iterator was created"));
				}
				if (b >= c.length){
					i(Pa);
				}
	...
	function C(a, b) {
		...
		this.L = [];
		if (a > this.gb){
			i(Error("[goog.structs.SimplePool] Initial cannot be greater than max"));
		}
		for(var c = 0; c < a; c++){
			this.L.push(this.X())
		}
	...
	function D(a, b) {a.L.length < a.gb ? a.L.push(b) : a.xa(b)}

	p.X = function () {return this.J ? this.J() : {}};
	p.xa = function (a) {
		if (this.Ua){
			this.Ua(a);
		}
	...
	function Ya(a) {return Za(a || arguments.callee.caller, [])}
	...
	function cb(a, b) {
		if (a.indexOf("#") >= 0 || a.indexOf("?") >= 0){
			i(Error("goog.uri.utils: Fragment or query identifiers are not supported: [" + a + "]"));
		}
		var c = a.length - 1;
		if (c >= 0 && a.indexOf("/", c) == c){
			a = a.substr(0, a.length - 1);
		}
		if (b.lastIndexOf("/", 0) == 0){
			b = b.substr(1);
		}
		return ta(a, "/", b)
	}
	...
	function F(a) {
		if (a.Sb){
			i(Error("Tried to modify a read-only Uri"))
		}
	}
	...
	function pb(a) {return a ? decodeURIComponent(a) : ""}
	...
	function Bb() {return q.navigator ? q.navigator.userAgent : m}
	...
	function Rb(a) {return Qb[a] || (Qb[a] = ua(Jb, a) >= 0)}
	...
	function Wb() {
		...
		if (c){
			if (w(c)){
				...
				u(c) ? wb.apply(m, [b].concat(c)) : Ub(b, c);
			}
		}
	...
	function Xb(a, b, c, d) {
		function e(g) {
			if (g){
				b.appendChild(w(g) ? a.createTextNode(g) : g)
			}
		}
	...
	function $b(a) {return Gb ? a.document || a.contentWindow.document : a.contentDocument || a.contentWindow.document}
	...
	gc.prototype.send = function (a, b, c, d) {
		...
		if (this.Oa > 0){
			f = q.setTimeout(ic(d, e, a, c), this.Oa);
		}
		c = this.ga.A();
		for(var g in a){
	...
	function kc(a, b, c) {
		q.setTimeout(function () {b && b.parentNode && b.parentNode.removeChild(b)}, 0);
		if (q._callbacks_[a]){
			if (c){
				delete q._callbacks_[a];
			}
			else {
				q._callbacks_[a] = ca
			}
	...
	;
	function lc(a, b, c, d, e) {this.reset(a, b, c, d, e)}
	...
	lc.prototype.kb = function (a) {this.ba = a};
	function K(a) {this.da = a}
	...
	K.prototype.kb = function (a) {this.ba = a};
	function tc(a) {
		if (a.ba){
			return a.ba;
		}
	...
	K.prototype.log = function (a, b, c) {
		if (a.value >= tc(this).value){
			...
			for(b = this; b;){
				...
				var d = a;
				if (c.db){
					for(var e = 0, f = void 0; f = c.db[e]; e++){
						f(d);
					}
				}
				b = b.na
	...
	K.prototype.info = function (a, b) {this.log(pc, a, b)};
	var uc = {}, vc = m;
	...
	function wc() {
		...
		this.Vb = 1;
		this.Aa = new C(0, 4E3);
		this.Aa.X = function () {return new xc};
		this.nb = new C(0, 50);
		this.nb.X = function () {return new yc};
		var a = this;
		this.Fa = new C(0, 2E3);
		this.Fa.X = function () {return String(a.Vb++)};
		this.Fa.xa = function () {};
		this.Hb = 3
	}

	wc.prototype.e = M("goog.debug.Trace");
	function yc() {this.Pa = this.pb = this.va = 0}
	...
	xc.prototype.toString = function () {return this.type == m ? this.Gb : "[" + this.type + "] " + this.Gb};
	...
	new wc;
	function Cc() {this.jb = ia()}

	new Cc;
	Cc.prototype.w = function (a) {this.jb = a};
	Cc.prototype.reset = function () {this.w(ia())};
	...
	p.ka = function (a, b, c, d, e, f) {
		if (x(a)){
			...
			if (a && a.handleEvent && x(a.handleEvent)){
				this.fb = n;
			}
			else {
				i(Error("Invalid listener argument"));
			}
		}
		this.ca = a;
		this.ib = b;
	...
	p.handleEvent = function (a) {
		if (this.fb){
			return this.ca.call(this.Ea || this.src, a);
		}
	...
	(function () {
		function a() {return{c:0, s:0}}

		function b() {return[]}

		function c() {
			function t(B) {return g.call(t.src, t.key, B)}

			return t
		}

		function d() {return new Fc}

		function e() {return new Ec}

		var f = Hc && !(ua(Ic, "5.7") >= 0), g;
		Oc = function (t) {g = t};
		if (f){
			Jc = function () {return Wa(h)};
			Kc = function (t) {D(h, t)};
			Lc = function () {return Wa(j)};
			Mc = function (t) {D(j, t)};
			Nc = function () {return Wa(k)};
			Pc = function () {D(k, c())};
			Qc = function () {return Wa(o)};
			Rc = function (t) {D(o, t)};
			Sc = function () {return Wa(r)};
			Tc = function (t) {D(r, t)};
			var h =
				new C(0, 600);
			h.J = a;
	...
	p.Ta = l;
	p.Ma = m;
	p.addEventListener = function (a, b, c, d) {Wc(this, a, b, c, d)};
	p.removeEventListener = function (a, b, c, d) {Yc(this, a, b, c, d)};
	...
	p.ob = function () {if (this.z)this.ab = fd(this.ob, 250, this)};
	function Fd() {}
	...
	(function () {
		...
		b.parse = function (h) {
			var j = new c(16), k = 0;
			h.toUpperCase().replace(/[0-9A-F][0-9A-F]/g, function (o) {j[k++] = f[o]});
			return j
		};
		b.rc = a;
		b.kc = c;
	...
	function W() {
		if (!V){
			...
			if (typeof ActiveXObject != "undefined"){
				V = {};
				var b = Ud();
				V.getPrinters = function () {return b.GetPrinters()};
				V.openLabelFile = function (e) {return b.OpenLabelFile(e)};
				V.printLabel = function (e, f, g, h) {b.PrintLabel(e, f, g, h)};
				V.renderLabel = function (e, f, g) {return b.RenderLabel(e, f, g)};
				V.loadImageAsPngBase64 = function (e) {return b.LoadImageAsPngBase64(e)};
				V.printLabel2 = function (e, f, g, h) {return b.PrintLabel2(e, f, g, h).toString()};
				V.getJobStatus =
					function (e, f) {
				...
				if (c){
					V = {};
					V.getPrinters = function () {return c.getPrinters()};
					V.openLabelFile = function (e) {return c.openLabelFile(e)};
					V.printLabel = function (e, f, g, h) {c.printLabel(e, f, g, h)};
					V.renderLabel = function (e, f, g) {return c.renderLabel(e, f, g)};
					V.loadImageAsPngBase64 = function (e) {return c.loadImageAsPngBase64(e)};
				...
				if (d = Od("application/x-dymolabel") ? Pd() : Td()){
					V = {};
					V.getPrinters = function () {return d.getPrinters()};
					V.openLabelFile = function (e) {
						var f = d.openLabelFile(e);
						if (!f)i(Error("Unable to open label file '" + e + "'"));
						return f
					};
					V.printLabel = function (e, f, g, h) {d.printLabel(g, e, f, h)};
					V.renderLabel = function (e, f, g) {return d.renderLabel(e, f, g)};
	...
	X.prototype.Ca = function () {return this.W.name};
	...
	function Zd(a, b) {
		...
		(new gc(tb(e, "getPrintJobStatus"), "callback")).send({jobId:d, printerName:a.W.ea}, function (f) {b(new Md(c, d, f.status, f.statusMessage))}, function () {b(new Md(c, d, Q.pa, 'Error processing getPrintJobStatus(): Unable to contact "' + e + '"'))})
	}
	...
	Y.toXml = $d;
	Y.prototype.toString = function () {return $d(this.sa)};
	function Z() {}
	...
	function $(a) {this.Qa = J(a)}

	$.prototype.Q = function () {return fc(this.Qa)};
	$.prototype.getLabelXml = $.prototype.Q;
	$.prototype.bc = function (a, b) {return ae(this.Q(), a, b)};
	$.prototype.render = $.prototype.bc;
	$.prototype.print = function (a, b, c) {be(a, b, this.Q(), c)};
	$.prototype.print = $.prototype.print;
	$.prototype.Yb = function (a, b, c) {return ce(a, b, this.Q(), c)};
	$.prototype.print2 = $.prototype.Yb;
	$.prototype.Zb = function (a, b, c, d, e) {return de(a, b, this.Q(), c, d, e)};
	...
	function fe(a, b) {
		var c = b || ee;
		return ac(a.Qa.documentElement, function (d) {return d.nodeType == 1 && Ea(c, d.tagName) >= 0})
	}
	...
	function ge(a) {return fe(a, ["AddressObject"])}

	$.prototype.Kb = function () {return ge(this).length};
	$.prototype.getAddressObjectCount = $.prototype.Kb;
	$.prototype.Jb = function (a) {return S(T(ge(this)[a], "BarcodePosition"))};
	...
	$.prototype.Lb = function (a) {return he(this, ge(this)[a])};
	$.prototype.getAddressText = $.prototype.Lb;
	$.prototype.ec = function (a, b) {return ie(this, ge(this)[a], b)};
	...
	function he(a, b) {return Ga(T(b, "StyledText").getElementsByTagName("String"), function (c, d) {return c + S(d)}, "")}
	...
	$.prototype.setBarcodeType = $.prototype.gc2;
	$.prototype.toString = function () {return this.Q()};
	...
	s("dymo.label.framework.removePrinterUri", function (a) {delete le[a]}, void 0);
	s("dymo.label.framework.removeAllPrinterUri", function () {le = {}}, void 0);
	function ne(a) {
		var b = J(a);
		a = [];
		var c = T(b, "Printers");
	...
	s("dymo.label.framework.getLabelWriterPrinters", function () {return pe("LabelWriterPrinter")}, void 0);
	s("dymo.label.framework.getTapePrinters", function () {return pe("TapePrinter")}, void 0);
	s("dymo.label.framework.openLabelFile", function (a) {return new $(W().openLabelFile(a))}, void 0);
	...
	function qe(a, b, c, d) {
		function e(j, k) {
			...
			}, function () {k < 10 ? e(j, ++k) : M("dymo.label.framework").error('Unable to send print job data for "' + f + '": error: Max retry count reached')})
		}
	...
	s("dymo.label.framework.renderLabelAsync", function (a, b, c, d) {
		...
		if (d == m || e != m && e.l == ""){
			...
			k = new gd(function () {
				...
				}, function () {k.start(1E3)})
			}, 500);
			k.start()
		}
	}, void 0);
	s("dymo.label.framework.loadImageAsPngBase64", function (a) {return W().loadImageAsPngBase64(a)}, void 0);
	...
	s("dymo.label.framework.createLabelRenderParamsXml", function (a) {
		function b(e, f) {R(d, e, undefined, {Alpha:f.a || f.alpha || 255, Red:f.r || f.red || 0, Green:f.g || f.green || 0, Blue:f.b || f.blue || 0})}
