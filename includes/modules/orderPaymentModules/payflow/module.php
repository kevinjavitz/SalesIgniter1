...
*/
	...
	class OrderPaymentPayflow extends CreditCardModule {
		...
		public function sendPaymentRequest($requestParams){
			...
			if (isset($requestParams['description'])) $dataArray['ORDERDESC'] = $requestParams['description'];
			...
			if (isset($requestParams['customerId'])) $dataArray['COMMENT1'] = $requestParams['customerId'];
			if (isset($requestParams['customerIp'])) $dataArray['CUSTIP'] = $requestParams['customerIp'];
			...
			if (isset($requestParams['customerState'])) $dataArray['STATE'] = $requestParams['customerState'];
			...
			if (isset($requestParams['cardType'])) $dataArray['ACCTTYPE'] = $requestParams['cardType'];
