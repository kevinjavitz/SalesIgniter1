...
class OrderPaymentMywholesaleaccount extends StandardPaymentModule {
	...
	public function __construct(){
		 ...
		 */
		$this->setTitle('My Wholesale Account');
		$this->setDescription('My Wholesale Account');
		
		$this->init('mywholesaleaccount');
	...
	public function sendPaymentRequest($requestData){
		return $this->onResponse(array(
			...
			'message' => sysLanguage::get('PAYMENT_MODULE_MYWHOLESALEACCOUNT_AWAITING_PAYMENT'),
			'success' => /*2*/1
		));
	}
