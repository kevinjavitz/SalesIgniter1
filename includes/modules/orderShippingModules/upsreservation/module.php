...
class OrderShippingUpsReservation extends OrderShippingModuleBase
{
	...
	private $_upsOriginPostalCode;
	private $_upsOriginCountryCode;
	private $_upsDestPostalCode;
	private $_upsDestCountryCode;
	private $_upsPackageWeight;
	private $_upsRateCode;
	private $_upsContainerCode;
	private $_upsResComCode;
	...
	public function quote($method = '', $shipping_weight = -1){
		...
		if (isset($deliveryAddress) && $method != 'all'){
			...
			$this->quotes = array(
				...
				'icon' => tep_image(sysConfig::get('DIR_WS_ICONS') . 'shipping_ups.gif', $this->getTitle()),
				'methods' => array()
			);
