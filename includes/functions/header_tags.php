...
function tep_get_header_tag_products_title($product_id) {
  $product_header_tags = tep_db_query("select products_head_title_tag from " . TABLE_PRODUCTS_DESCRIPTION . " where language_id = '" . (int)Session::get('languages_id') . "' and products_id = '" . (int)$_GET['products_id'] . "'");
...
function tep_get_header_tag_products_keywords($product_id) {
  $product_header_tags = tep_db_query("select products_head_keywords_tag from " . TABLE_PRODUCTS_DESCRIPTION . " where language_id = '" . (int)Session::get('languages_id') . "' and products_id = '" . (int)$_GET['products_id'] . "'");
  $product_header_tags_values = tep_db_fetch_array($product_header_tags);
...
function tep_get_header_tag_products_desc($product_id) {
  $product_header_tags = tep_db_query("select products_head_desc_tag from " . TABLE_PRODUCTS_DESCRIPTION . " where language_id = '" . (int)Session::get('languages_id') . "' and products_id = '" . (int)$_GET['products_id'] . "'");
  $product_header_tags_values = tep_db_fetch_array($product_header_tags);
