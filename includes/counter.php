...
*/
  ...
  $counter_startdate_formatted = strftime(sysLanguage::getDateFormat('long'), mktime(0, 0, 0, substr($counter_startdate, 4, 2), substr($counter_startdate, -2), substr($counter_startdate, 0, 4)));
?>
